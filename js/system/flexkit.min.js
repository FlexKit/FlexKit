...
tapButton("sub-menu-btn",function(a){a.stopPropagation();a.preventDefault();$(a.target).toggleClass("active").nextAll("ul").toggleClass("open")});var body=document.body;$(body).on(events[0],hideMenu);
