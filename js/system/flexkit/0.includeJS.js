(function () {
    ...
    var url = document.querySelector('[href*="themes"]').getAttribute('href'), websiteUrl = url.substring(url.indexOf('themes', 10), 0), themeIndex = url.indexOf('themes') + 7, themeName = url.substring(themeIndex, url.indexOf('/', themeIndex));
